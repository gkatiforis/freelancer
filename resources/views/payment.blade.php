    ...
    <div class="container" style="padding-top: 60px;">
        <div class="row-fluid" >
            <div class="span6 offset6" style="float: none; margin: 0 auto;">
                <h4 class="page-header">Υπόλοιπο Λογαριασμού: <span style="font-size: 22px;">{{$user['balance']}} €</span>
        ...
        <div class="row-fluid" >
            <div class="span6 offset6" style="float: none; margin: 0 auto;">
                <h4>Κατάθεση Χρημάτων Μέσω Paypal    </h4>
            </div>
        </div>
            ...
            <form data-toggle="validator" role="form" method="POST" action="/payment" enctype="multipart/form-data">
                ...
                <div id="formDiv">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" min="0" 1 data-bind="value:replyNumber" required  id="amount" min="0" data-bind="value:replyNumber"  name="amount" class="form-control" required>
                    </div>
